...
int main()
{
	...
	Ptr<SurfFeatureDetector> detector = SurfFeatureDetector::create(800);//创建SIFT特征检测器，可改成SURF/ORB
	//Ptr<SiftFeatureDetector> detector = SiftFeatureDetector::create(100);//创建SIFT特征检测器，可改成SURF/ORB

	Ptr<SurfDescriptorExtractor> descriptor_extractor = SurfDescriptorExtractor::create(800);//创建特征向量生成器，可改成SURF/ORB
	//Ptr<SiftDescriptorExtractor> descriptor_extractor = SiftDescriptorExtractor::create(100);//创建特征向量生成器，可改成SURF/ORB
